...
class server(torch.nn.Module):
    ...
    def config ():
        ...
        # deepspeed arguments
        parser.add_argument('--deepspeed.deepspeed_config', type=str, help='If set, defaults are overridden by passed file.', default='/home/ubuntu/.bittensor/bittensor/bittensor/_neuron/text/core_server/ds_config.json')
